      ...
      <article className="rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="mt-4 leading-relaxed text-slate-700">{profile.bio}</p>
          </div>
        </div>
        ...
        <section className="mt-8 border-t border-slate-100 pt-8">
          ...
          <p className="text-sm leading-relaxed text-slate-600">
            Dog Viewer is a React exercise that loads random dog images from the{' '}
            <a
            ...
            , lets you browse a gallery, and save favorites in your browser.
          </p>
        </section>
      </article>
    </main>
